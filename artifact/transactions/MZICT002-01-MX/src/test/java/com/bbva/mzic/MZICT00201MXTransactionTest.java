...
/**
 * Test for transaction MZICT00201MXTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/MZICT00201MXTest.xml" })
public class MZICT00201MXTransactionTest {

	@Autowired
	private MZICT00201MXTransaction transaction;
